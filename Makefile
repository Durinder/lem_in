...
#    Updated: 2021/11/02 12:34:25 by vhallama         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LEM-IN = lem-in
LEM-IN_SRC = lem-in.c initialize.c initialize_assigns.c initialize_validating.c free_structs.c graph.c linked_list.c queue.c flags.c routing.c routing_save.c graph_save.c move_ants.c
